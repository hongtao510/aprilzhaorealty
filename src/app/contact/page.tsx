    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-6">
          <div className="w-20 h-20 bg-[#b1ff8f] rounded-full flex items-center justify-center mx-auto mb-6">
            <svg className="w-10 h-10 text-[#381b5e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div>
      ...
      <section className="bg-[#381b5e] text-white py-20 relative overflow-hidden">
        <div className="absolute top-0 left-1/2 w-96 h-96 bg-[#ff771c] rounded-full blur-3xl opacity-10" />
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="lg:pl-8">
            <div className="bg-zinc-50 rounded-3xl p-8 mb-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-[#b1ff8f] rounded-xl flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <a href="mailto:aprilcasf@gmail.com" className="text-[#381b5e] hover:underline">
                      aprilcasf@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-[#c181ff] rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            {/* Quick response */}
            <div className="bg-[#381b5e] text-white rounded-3xl p-8">
