...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>April Zhao | Bay Area Real Estate Agent</title>
        <meta name="description" content="Your trusted real estate partner in the San Francisco Bay Area. Expert guidance for buying and selling homes in San Jose, San Mateo, and surrounding areas." />
      </head>
      <body className={`${inter.variable} ${playfair.variable} font-sans antialiased min-h-screen flex flex-col bg-white`}>
        <Header />
